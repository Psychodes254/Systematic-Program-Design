...
(check-expect (potter--loc empty) empty)
(check-expect (potter--p D1) (list (list "Bill Weasley" "Fleur Delacour")
                                   "Victoire Weasley" "Dominique Weasley" "Louis Weasley"))
(check-expect (potter--p D2) (list (list "Percy Weasley" "Audrey Weasley")
                                   "Molly Weasley" "Lucy Weasley"))
(check-expect (potter--p D3) (list (list "George Weasley" "Angelina Johnson")
                                         "Fred Weasley" "Roxanne Weasley"))
(check-expect (potter--p D4) (list (list "Ronald Weasley" "Hermione Granger")
                                   "Rose Weasley" "Hugo Granger-Weasley"))
(check-expect (potter--p D5) (list (list "James Potter" "Lily Luna Potter")
                                         "Sirius Potter" "Severus Potter" "Luna Potter"))
(check-expect (potter--p ARTHUR) (list (list "Arthur Weasley" "Molly Prewett")
...
;(define (potter--child c) empty)          ;stubs
;(define (potter--p p) empty)
;(define (potter--loc loc) empty)

(define (potter--child c)
...
;(define (child--name c) "")     ;stubs
;(define (potter--name n) "")
;(define (potter--lon lon) empty)
